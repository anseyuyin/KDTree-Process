System.register(["./kdTree.js"], function (exports_1, context_1) {
    ...
    var kdTree_js_1, data, pointsData, svgNS, helpv2, helpv2s, main;
    return {
        setters: [
        ...
        execute: function () {
            ...
            main = (function () {
                ...
                main.prototype.init = function () {
                    ...
                    if (this.trigger_Down) {
                        ...
                        ssvg.onpointerdown = function (ev) {
                            downPoint_1[0] = ev.offsetX;
                            downPoint_1[1] = ev.offsetY;
                            self.calcuPoints(searchR, downPoint_1);
                        };
                    }
                    else {
                        var movePoint_1 = [0, 0];
                        ssvg.onpointermove = function (ev) {
                            if (ev.offsetX == movePoint_1[0] && ev.offsetY == movePoint_1[1])
                                return;
                            movePoint_1[0] = ev.offsetX;
                            movePoint_1[1] = ev.offsetY;
                            self.calcuPoints(searchR, movePoint_1);
                        };
                    }
                    var maxW = 460;
                    var maxH = 560;
                    ...
                    kdData.forEach(function (sub) {
                        if (sub) {
                            var key = sub[0] + "_" + sub[1];
                            var po = _this.makeCirPoint(rsize, sub, ssvg);
                            _this.pointes.push(po);
                            _this.pointeDic[key] = po;
                        }
                    });
                    this.kd.buildTree(kdData);
                    this.inited = true;
                };
                main.prototype.calcuPoints = function (searchR, movePoint) {
                ...
                main.prototype.moveCirFrame = function (searchR, movePoint) {
                    var arr = this.crateCirData(searchR, movePoint);
                    this.cir.setAttribute("points", arr.toString());
                };
                main.prototype.searchNear = function (movePoint) {
                    if (this.inited) {
                ...
                main.prototype.searchPoints = function (searchR, movePoint) {
                    if (this.inited) {
                        this.kd.search(searchR, movePoint, helpv2s);
                        this.refreashPoints(helpv2s);
                    }
                };
                main.prototype.refreashPoints = function (points) {
                    var _this = this;
                    ...
                    points.forEach(function (v2) {
                        if (v2) {
                            var key = v2[0] + "_" + v2[1];
                            pos.push(_this.pointeDic[key]);
                        }
                    });
                    if (pos.length > 0) {
                        this.pointes.forEach(function (sub) {
                            if (sub) {
